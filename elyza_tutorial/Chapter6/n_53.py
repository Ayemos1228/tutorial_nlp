...
if __name__ == "__main__":
    category, prob = get_prediction(
        "maxf_5000.pickle",
        "tf-idfvectorizer.pickle",
        "Britain's Top Credit Rating Secured at S&P After Outlook Raised",
    )
    print(
        f"Correct category = b, Predicted category = {category}, prob = {prob}"
    )  # これだとどのカテゴリーのprobがどれだか分からそう、題意的には予測したものの確率だけ出せば良さそう、？
